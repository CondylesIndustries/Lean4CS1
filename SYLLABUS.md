...
care of it. The social equation is you-are-accountable implies less-likely-to-fail. The idea
underpins the notion of a legal system in which real people are punished. (At least that's the
theory.) And justified, properly calibrated trust is crucial to the success of a system and the
surrounding society.
